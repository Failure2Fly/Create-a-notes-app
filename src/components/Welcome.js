  ...
  <div className="tile is-vertical is-8">
    ...
    <div className="tile is-parent">
      <article className="message is-danger">
                    ...
                    <div className="message-body">
                    You can add tags to your notes in order to make searching for them easier. When writing a new note make sure to add tags at the bottom in the <strong>Tags section</strong> that correlate to the topic being written. For example if you were writing about a dream you had you might use the tags <strong>#dream #sleep #rem #nightnight #zzzzzz #snooze</strong> That way in the future (say 6 months form now) it will make finding that specific note all the more easy to find. <strong> In conclusion Tags = Good.</strong>
                    </div>
                </article>
    </div>
  </div>
